...
@section('content-admin')
    ...
    <a href="{{ route('categories.create')}}">
        <svg xmlns="http://www.w3.org/2000/svg" width="2%" fill="currentColor" class="bi bi-calendar2-plus"
             viewBox="0 0 16 16">
            <path
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('categories.edit',['id' => $category->id])}}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="4%" fill="currentColor"
                    ...
                    <td>
                        <a href="{{ route('categories.destroy',['id' => $category->id])}}">
                            <svg style="color: red" xmlns="http://www.w3.org/2000/svg" width="4%" fill="currentColor"
